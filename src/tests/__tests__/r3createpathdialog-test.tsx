...
import R3CreatePathDialog		from '../../components/r3createpathdialog';
...
const testTheme = {
	...r3Theme,
	r3CreatePathDialog: {
		...r3Theme.r3CreatePathDialog,
		root: {
			...r3Theme.r3CreatePathDialog.root,
...
describe('R3CreatePathDialog', () =>
{
	...
	it('test snapshot for R3CreatePathDialog', () => {
