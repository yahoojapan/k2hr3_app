...
import R3AccountDialog			from '../../components/r3accountdialog';
...
const testTheme = {
	...r3Theme,
	r3AccountDialog: {
		...r3Theme.r3AccountDialog,
		root: {
			...r3Theme.r3AccountDialog.root,
...
describe('R3AccountDialog', () =>
{
	...
	it('test snapshot for R3AccountDialog', () => {
