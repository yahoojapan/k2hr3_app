...
import R3PathInfoDialog			from '../../components/r3pathinfodialog';
...
const testTheme = {
	...r3Theme,
	r3PathInfoDialog: {
		...r3Theme.r3PathInfoDialog,
		root: {
			...r3Theme.r3PathInfoDialog.root,
...
describe('R3PathInfoDialog', () =>
{
	...
	it('test snapshot for R3PathInfoDialog', () => {
			...
			<StyledEngineProvider injectFirst>
				<ThemeProvider theme={ testTheme } >
					...
					<R3PathInfoDialog
						...
						userDataScript={ '#!/bin/sh\ncurl -s -S -v -X PUT -H "x-auth-token: R=JEST_TEST_ROLE_TOKEN" "http://localhost:3000/v1/role/JEST_OWNER_SERVICE"' }
