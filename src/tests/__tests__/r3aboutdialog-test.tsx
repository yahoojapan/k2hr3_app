...
import R3AboutDialog			from '../../components/r3aboutdialog';
...
const testTheme = {
	...r3Theme,
	r3AboutDialog: {
		...r3Theme.r3AboutDialog,
		root: {
			...r3Theme.r3AboutDialog.root,
...
describe('R3AboutDialog', () =>
{
	...
	it('test snapshot for R3AboutDialog', () => {
