...
import R3SigninCredDialog		from '../../components/r3signincreddialog';
...
const testTheme = {
	...r3Theme,
	r3SigninCredDialog: {
		...r3Theme.r3SigninCredDialog,
		root: {
			...r3Theme.r3SigninCredDialog.root,
...
describe('R3CreateServiceDialog', () =>
{
	...
	it('test snapshot for R3SigninCredDialog', () => {
